...
public class LeverageRatioDataReader {
	
	public static void main(String[] args) {
		HashMap<String, ArrayList<Double>> LeverageData = new HashMap<String, ArrayList<Double>>();
		ArrayList<String> stockList = new ArrayList<String>();

		try {
			FileReader f = new FileReader("leverageratio.csv");
			...
			while(scanner.hasNextLine()) {
				...
				LeverageData.put(stockTicker,cast);
			}

			// retrieve movie information
			System.out.println(stockList);
			for(int i = 0; i < stockList.size(); i++) {
				System.out.print(LeverageData.get(stockList.get(i)));
				System.out.println();
			}
