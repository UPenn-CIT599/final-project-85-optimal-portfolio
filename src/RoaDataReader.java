...
public class RoaDataReader {
	
	public static void main(String[] args) {
		HashMap<String, ArrayList<Double>> RoaData = new HashMap<String, ArrayList<Double>>();
		ArrayList<String> stockList = new ArrayList<String>();

		try {
			FileReader f = new FileReader("roa.csv");
			...
			while(scanner.hasNextLine()) {
				...
				RoaData.put(stockTicker,cast);
			}

			// retrieve movie information
			System.out.println(stockList);
			for(int i = 0; i < stockList.size(); i++) {
				System.out.print(RoaData.get(stockList.get(i)));
				System.out.println();
			}
